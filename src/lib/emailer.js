...
const sendMailAdvert = async (userAdvert, user, advert) => {
  const template = `
<head>
  <link
    href="https://fonts.googleapis.com/css2?family=Imprima&display=swap"
                              ...
                              <tr>
                                ...
                                >
                                  <h3
                                    ...
                                    "
                                  >
                                    Hola ${userAdvert.name}, el usuario ${user.name} desea contactar contigo:
                                  ...
                                  <p
                                    ...
                                    "
                                  >
                                    <br />Con motivo del anuncio:<br/>
                                    Nombre: ${advert.name}<br />
                                    Compañia: ${advert.company}<br />
                                    PEGI: ${advert.PGI}<br />
                                    Precio: ${advert.price}<br />
                                    <br/>
                                    Si deseas contactar con el, enviale un correo a:<br />Usuario:
                                    ${user.name}.<br />Em@il: ${user.email}<br /><br />UwUGracias!.
                                  </p>
                                </td>
                              </tr>
                            </table>
...
`;
  ...
  const info = await transporter.sendMail({
    from: '"UwuntuGames🛒" <UwuntuGames@games.com>',
    to: userAdvert.email,
    subject: `Hola ${userAdvert.name}, el usuario ${user.name} desea contactar contigo`,
    html: template,
  });
...
exports.sendMailAdvert = (userAdvert, user, advert) =>
  sendMailAdvert(userAdvert, user, advert);
